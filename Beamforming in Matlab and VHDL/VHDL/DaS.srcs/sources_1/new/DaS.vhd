...
package types is
    ...
    type outputCol_t is array(0 to outputLength) of output_sample_t;
    type output_t is array(0 to angleRange - 1) of outputCol_t;
end package types;
...
begin
    ...
    variable output : output_t := (others => (others => 0));
    begin
        if rising_edge(clk) then
